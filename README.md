...
Adding a little note about annotation, the languages that use Latin alphabets (A-Z) routinely add annotations to the closest alphabets to describe their unique sounds. Why not do this in Hangul?
