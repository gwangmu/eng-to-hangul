...
tune_cons_w_vowel = {
    ...
    'ㄸ': {
        ...
        'ㅘ': ((-.02, 0.39), (0.75, 0.61)),
        'ㅙ': ((-.02, 0.39), (0.75, 0.61)),
        'ㅚ': ((0.02, 0.39), (0.75, 0.61)),
        'ㅛ': ((0.03, 0.35), (0.92, 0.65)),
        'ㅜ': ((0.03, 0.46), (0.92, 0.54)),
        'ㅝ': ((0.02, 0.46), (0.71, 0.54)),
        'ㅞ': ((-.02, 0.46), (0.75, 0.54)),
        'ㅟ': ((0.02, 0.46), (0.71, 0.54)),
        'ㅠ': ((0.06, 0.46), (0.92, 0.54)),
        'ㅡ': ((0.04, 0.28), (0.94, 0.72)),
        'ㅢ': ((0.02, 0.40), (0.96, 0.60)),
        'ㅣ': ((-.02, 0.10), (0.65, 0.90)),
    },
}
